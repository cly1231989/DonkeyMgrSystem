jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					colModel:[
						...
						{label:'养殖地址', 	name:'breedaddress', 	index:'breedaddress', 	editable:true, 		width:150, 		sortable:false, 		search:false,		edittype:'textarea',		editoptions:{rows:"1",cols:"50"}},
						{label:'供应商', 		name:'supplier', 		index:'supplier', 		editable:true, 		width:120, 		sortable:false,			search:false},
						{label:'供应地址', 	name:'supplyaddress', 	index:'supplyaddress', 	editable:true, 		width:150, 		sortable:false, 		search:false,		edittype:'textarea',		editoptions:{rows:"1",cols:"50"}},
